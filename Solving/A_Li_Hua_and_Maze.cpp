...
ll solve1(){
   ...
   if(x1==1 && y1==m) return 2;
   if(x1==n && y1==m) return 2;
   if(x1==n && y1==1) return 2;

   if(x2==1 && y2==1) return 2;
   if(x2==1 && y2==m) return 2;
   if(x2==n && y2==m) return 2;
   if(x2==n && y2==1) return 2;


   if(x1==1 || x2==1 || x1==n || x2==n || y1==1 || y2==1 || y2==m || y1==m ) return 3;
